function [FullDataJ,FileNamesJ]=data_loadOFF(channel)
...
cd ../
cd ../
cd './Dataset/UNMDataset_OFF/Organized_data'
...
load 'EEG_Jim_rest_OFF_Unsegmented_WithAllChannels.mat'; % rest jims data
