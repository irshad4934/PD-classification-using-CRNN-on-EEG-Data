function [acc_Kfold,all_scores,all_classes]=kfold_acc_helper_func(SelectedChans,YWTr_all,TrainingLabels,TrainingClasses,AllParams,best_comb,is_normalized_projection,k)
...
elseif k==0
    ...
    KFoldData = cvpartition(TrainingClasses,'KFold',k);
end
